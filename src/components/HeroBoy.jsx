...
Files: boy.glb [1.08MB] > E:\portfolio\public\models\boy-transformed.glb [495.53KB] (54%)
*/
...
export function HeroBoy(props) {
  ...
  const group = useRef();
  const [isIntoAnimationDone, setIsIntoAnimationDone] = useState(false);

  useGSAP(() => {
    if (!isIntoAnimationDone) {
      gsap.fromTo(
